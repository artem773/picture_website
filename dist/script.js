...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pictuerSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
/***/ "./src/js/modules/accordionMenu.js":
/*!*****************************************!*\
  !*** ./src/js/modules/accordionMenu.js ***!
  \*****************************************/
...
var accordionMenu = function accordionMenu(triggersSelector) {
  ...
  txtInputs.forEach(function (input) {
    input.addEventListener('keypress', function (e) {
      if (e.key.match(/[^a-z 0-9]/ig)) {
        //можно вводити тільки латінніцу і цифри
        e.preventDefault();
      }
    });
  });
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var arr = item.files[0].name.split('.'); // 'asdasdasdasd.png' => ['asdasdasd', 'png']
...
var pictureSize = function pictureSize(selectorImg) {
  var block = document.querySelectorAll(selectorImg);
...
var sliders = function sliders(_sliders, dir, prev, next) {
  ...
  function showSlides(n) {
    if (n > items.length) {
      //еслі чісло n больше чем кол-во слайдов, то показиваем первий слайд
      slideIndex = 1;
    }

    if (n < 1) {
      //еслі чісло n меньше чем кол-во слайдов, то показиваем последній слайд
